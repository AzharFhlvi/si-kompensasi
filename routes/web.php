...
// Main Page Route
Route::get('/templates', $controller_path . '\dashboard\Analytics@index')->name('dashboard-analytics');
...
Route::group(['prefix' => "kompensasi"], function () {
    ...
    Route::get('/download/surat/{id}', [App\Http\Controllers\KompensasiController::class, 'downloadSurat'])->name('kompensasi-download-surat')->middleware('checkrole:2');
...
Route::group(['prefix' => 'mahasiswa', 'middleware' => 'checkrole:4'], function () {
    ...
    Route::get('/destroy/{id}', [App\Http\Controllers\MahasiswaController::class, 'destroy'])->name('mahasiswa-destroy');
});
